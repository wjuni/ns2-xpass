...
class XTSendCreditTimer: public TimerHandler {
public:
  XTSendCreditTimer(XPassTcpAgent *a): TimerHandler(), a_(a) { }
protected:
  virtual void expire(Event *);
  XPassTcpAgent *a_;
};

class XTCreditStopTimer: public TimerHandler {
public:
  XTCreditStopTimer(XPassTcpAgent *a): TimerHandler(), a_(a) { }
protected:
  virtual void expire(Event *);
  XPassTcpAgent *a_;
};

class XTSenderRetransmitTimer: public TimerHandler {
public:
  XTSenderRetransmitTimer(XPassTcpAgent *a): TimerHandler(), a_(a) { }
protected:
  virtual void expire(Event *);
  XPassTcpAgent *a_;
};

class XTReceiverRetransmitTimer: public TimerHandler {
public:
  XTReceiverRetransmitTimer(XPassTcpAgent *a): TimerHandler(), a_(a) { }
protected:
  virtual void expire(Event *);
  XPassTcpAgent *a_;
};
...
class XPassTcpAgent : public FullTcpAgent {
  friend class XTSendCreditTimer;
  friend class XTCreditStopTimer;
  friend class XTSenderRetransmitTimer;
  friend class XTReceiverRetransmitTimer;




public:
  XPassTcpAgent() : FullTcpAgent(), credit_send_state_(XPASS_SEND_CLOSED),
...
protected:
  ...
  XTSendCreditTimer send_credit_timer_;
  XTCreditStopTimer credit_stop_timer_;
  XTSenderRetransmitTimer sender_retransmit_timer_;
  XTReceiverRetransmitTimer receiver_retransmit_timer_;
